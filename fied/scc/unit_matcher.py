...
The standardized, Level 1 fuel types are shown below.
    ...
    def __init__(self):
        ...
        # Why missing flare, stove, distillation, engine, generator, oxidizer, pump, compressor, builing heat, cupula, PCWD, PCWW, PCT, OFB, reciprocating, roaster
    ...
    def char_ghgrp_units(self, ghgrp_data):
        ...
        Gui Notes:
        - Give something like below for ocs_types:
       unitTypeLv1       unitTypeLv2
0      Other combustion  Other combustion
1      Other combustion  Other combustion
2      Other combustion  Other combustion
3      Other combustion  Other combustion
4      Other combustion  Other combustion
...                 ...               ...
18922            Boiler            Boiler
18923            Boiler            Boiler
18924            Boiler            Boiler
18925  Other combustion  Other combustion
        """
        ...
        # Gui: Extra step here handling COB (By-product...)
        ...
        for df in [ocs_types, none_types]:
            ...
            # There is an issue with unit_regex. Figure out what was the
            # intention here.
        ...
        ghgrp_data["unitType"] = ghgrp_data["UNIT_TYPE"]

        return ghgrp_data

    # What was the expectation here? This function has some issues.
    # Look the conditional. it will always return 'Other combustion'.
