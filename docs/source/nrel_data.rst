...
* `Combustion Energy Use dataset <https://doi.org/10.7799/1278644>`_
* `NLR/INL joint technical report:  <https://doi.org/doi:10.2172/1334495>`_
...
* `Process Heat Demand dataset <https://doi.org/10.7799/1461488>`_
* `Paper published in *Applied Energy* <https://doi.org/10.1016/j.apenergy.2019.01.077>`_
* `Heat Demand Analysis GitHub repository <https://github.com/NatLabRockies/Industrial-Heat-Demand-Analysis>`_
...
* `Industry Energy Tool GitHub repository <https//github.com/NatLabRockies/Industry-Energy-Tool/>`_
...
* `Solar for Industry Process Heat GitHub repository <https://github.com/NatLabRockies/Solar-for-Industry-Process-Heat/>`_
...
* `Industrial Energy Data Book dataset <https://doi.org/10.7799/1575074>`_
* `EERE Industrial Energy Data Book <https://www.energy.gov/eere/analysis/articles/2018-industrial-energy-data-book>`_
* `Industry Energy Data Book GitHub repository <https://github.com/NatLabRockies/Industry-energy-data-book>`_
...
* `NLR report: The Foundational Industry Energy Dataset (FIED): Open-Source Data on Industrial Facilities <https://www.nlr.gov/docs/fy24osti/90442.pdf>`_
* `FIED GitHub repository <https://github.com/NatLabRockies/foundational-industry-energy-data/>`_
